...
ALTER TABLE ONLY "public"."borrow"
    ADD CONSTRAINT "borrow_borrower_id_fkey" FOREIGN KEY ("borrower_id") REFERENCES "public"."user"("user_id");

ALTER TABLE ONLY "public"."messages"
    ADD CONSTRAINT "messages_borrow_id_fkey" FOREIGN KEY ("borrow_id") REFERENCES "public"."borrow"("id");

ALTER TABLE ONLY "public"."messages"
    ADD CONSTRAINT "messages_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."user"("user_id");

ALTER TABLE ONLY "public"."user_book"
    ADD CONSTRAINT "user_book_book_isbn_fkey" FOREIGN KEY ("book_isbn") REFERENCES "public"."book"("isbn");

ALTER TABLE ONLY "public"."user_book"
    ADD CONSTRAINT "user_book_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."user"("user_id");
